                                               ...
                                               const uint8_t *B)
{
  const __m128i mask_rev64_epi16=_mm_set_epi64x((uint64_t)0x9080b0a0d0c0f0e,
                                                (uint64_t)0x100030205040706);
  __m128i e,S,w0,w1,u00,u10,u20,u30,u40,u50,u60,u70,u80,u90,ua0,u01,u11,u21,u31,
          u41,u51,u61,u71,u81,u91,ua1,B0,B1,B00,B10,B01,B11,mask_U;
  unsigned int j;
  ...
  B0=_mm_loadu_si128((__m128i*)u+6);
  B1=_mm_loadu_si128((__m128i*)u+7);
  /* 7 6 5 4 3 2 1 0 --> 1 0 3 2 5 4 7 6 */
  B0=_mm_shuffle_epi8(B0,mask_rev64_epi16);
  B1=_mm_shuffle_epi8(B1,mask_rev64_epi16);
  /* even bytes *x^8 */
  u70=_mm_slli_epi16(B0,8);
  u80=_mm_slli_epi16(B1,8);
  /* odd bytes */
  u71=_mm_srli_epi16(B0,8);
  u81=_mm_srli_epi16(B1,8);

  B0=_mm_loadu_si128((__m128i*)u+8);
  B1=_mm_loadu_si128((__m128i*)u+9);
  /* 7 6 5 4 3 2 1 0 --> 1 0 3 2 5 4 7 6 */
  B0=_mm_shuffle_epi8(B0,mask_rev64_epi16);
  B1=_mm_shuffle_epi8(B1,mask_rev64_epi16);
  /* even bytes *x^8 */
  u90=_mm_slli_epi16(B0,8);
  ua0=_mm_slli_epi16(B1,8);
  /* odd bytes */
  u91=_mm_srli_epi16(B0,8);
  ua1=_mm_srli_epi16(B1,8);
  ...
  for(j=0;j<NDIMR;++j)
  {
    ...
    /* repeat the previous process */
    B0=_mm_loadu_si128((__m128i*)B+8);
    B1=_mm_loadu_si128((__m128i*)B+9);
    ...
    /* each carry-less multiplication performs a dot product */
    w0^=_mm_clmulepi64_si128(u80,B00,0);
    w0^=_mm_clmulepi64_si128(u80,B00,0x11);
    w0^=_mm_clmulepi64_si128(u90,B10,0);
    w0^=_mm_clmulepi64_si128(u90,B10,0x11);
    w1^=_mm_clmulepi64_si128(u81,B01,0);
    w1^=_mm_clmulepi64_si128(u81,B01,0x11);
    w1^=_mm_clmulepi64_si128(u91,B11,0);
    w1^=_mm_clmulepi64_si128(u91,B11,0x11);

    /* repeat the previous process */
    B0=_mm_loadu_si128((__m128i*)B+10);
    ...
    /* each carry-less multiplication performs a dot product */
    w0^=_mm_clmulepi64_si128(ua0,B00,0);
    w0^=_mm_clmulepi64_si128(ua0,B00,0x11);
    w1^=_mm_clmulepi64_si128(ua1,B01,0);
    w1^=_mm_clmulepi64_si128(ua1,B01,0x11);
  ...
  for(;j<(16+NDIMR);++j)
  {
    ...
    w0^=_mm_clmulepi64_si128(u80,B10,0);
    w0^=_mm_clmulepi64_si128(u80,B10,0x11);
    w1^=_mm_clmulepi64_si128(u71,B01,0);
    w1^=_mm_clmulepi64_si128(u71,B01,0x11);
    w1^=_mm_clmulepi64_si128(u81,B11,0);
    w1^=_mm_clmulepi64_si128(u81,B11,0x11);
    ...
    /* each carry-less multiplication performs a dot product */
    w0^=_mm_clmulepi64_si128(u90,B00,0);
    w0^=_mm_clmulepi64_si128(u90,B00,0x11);
    w0^=_mm_clmulepi64_si128(ua0,B10,0);
    w0^=_mm_clmulepi64_si128(ua0,B10,0x11);
    w1^=_mm_clmulepi64_si128(u91,B01,0);
    w1^=_mm_clmulepi64_si128(u91,B01,0x11);
    w1^=_mm_clmulepi64_si128(ua1,B11,0);
    w1^=_mm_clmulepi64_si128(ua1,B11,0x11);
